...
from config.setting import EMB_CHANNEL
from model.modules.conv import BaseConv, DoubleConv, VAEConv2d
...
class UpBlock(nn.Module):
    ...
    def forward(self, x, skip_x, time, y=None, skip_y=None):
        """
        UpBlock forward
        :param x: Input
