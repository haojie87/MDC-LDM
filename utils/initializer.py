...
from iddm.model.networks.swin_unet import SwinUNet
...
def sample_initializer(sample, image_size, device, schedule_name="linear", **kwargs):
    """
    Initialize sample
    ...
    :param kwargs: Additional arguments for the diffusion model
    :return: diffusion
    """
    if sample == "ddpm":
